...
The lab was built using **Docker** and **Docker Compose on a Windows host machine. The 'docker-compose.yml' file defines the two containers and a private network to allow them to communicate. `git clone`
